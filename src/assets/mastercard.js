...
const SvgMcVrtPos = props => (
  <svg viewBox="0 0 146.8 120.41" {...props}>
    <defs>
      <style>{".mc_vrt_pos_svg__cls-5{fill:white}"}</style>
    </defs>
    <g id="mc_vrt_pos_svg__Layer_2" data-name="Layer 2">
      <g id="mc_vrt_pos_svg__Layer_1-2" data-name="Layer 1">
        ...
        <path
          ...
          fill="white"
        />
        <g id="mc_vrt_pos_svg___Group_" data-name="&lt;Group&gt;">
          <path fill="white" d="M57.65 22.85h31.5v56.61h-31.5z" />
          <path
            id="mc_vrt_pos_svg___Path_"
            data-name="&lt;Path&gt;"
            d="M59.65 51.16A35.94 35.94 0 0173.4 22.85a36 36 0 100 56.61 35.94 35.94 0 01-13.75-28.3z"
            fill="white"
          />
          <path
            className="mc_vrt_pos_svg__cls-5"
